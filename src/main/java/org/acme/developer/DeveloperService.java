...
public class DeveloperService {
    ...
    public String deleteDeveloper(String email, UUID apiKey, String password) {
        ...
        if (email.equals(developer.getEmail()) && apiKey.equals(developer.getApiKey())
                && securePassword.equals(developer.getPassword())) {
            deleteDeveloper(developer.getId());
            return "Developer raderad!";
        } else {
            return "Developer inte raderad! Något matchar inte!";
        }
    }
